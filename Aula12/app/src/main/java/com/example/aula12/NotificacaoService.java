...
public class NotificacaoService extends Service {
    boolean isRunning = false, isScheduled = false;
    ...
    private void criarNotificação(String temp, String umidade, String dt, int id) {
        ...
        NotificationCompat.Builder build = new NotificationCompat.Builder(getApplicationContext(),  "my_channel_01");

        Notification not = build.setContentIntent(pi).setSmallIcon(icone).setAutoCancel(false).setTicker(text).setContentTitle(dt)

...
public class SlidesActivity extends AppCompatActivity {
    ...
    String[] categoria_gasto = {"Água", "Luz", "Telefone", "Outros"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<CharSequence> adapter1 = ArrayAdapter.createFromResource(this, R.array.categoria_gasto, R.layout.meu_spinner_item);
        ...
        ArrayAdapter<String> adapter2 = new ArrayAdapter<>(this, android.R.layout.simple_spinner_item, categoria_gasto);
        categoria2.setAdapter(adapter2);

        categoria2.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(getApplicationContext(), "Item selecionado: "+categoria_gasto[position], Toast.LENGTH_SHORT).show();
            }
        ...
        ArrayAdapter<String> adapter3 = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, Arrays.asList(gastos));
        listView.setAdapter(adapter3);

        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            @Override
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Toast.makeText(getApplicationContext(), "Selecionado: "+gastos[position], Toast.LENGTH_SHORT).show();
            }
        });
    }
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        switch(item.getItemId()){
            case R.id.itemNew:
                ...
                Intent intent = new Intent(this, SlidesListActivity.class);
